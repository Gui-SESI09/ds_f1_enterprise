...
*   **CRM / Funil de Vendas:** Quadro visual estilo Kanban para acompanhar as etapas de negociação (*Prospecção, Contato, Proposta, Parceria Fechada*).
*   **Gestão Orçamentária:** Definição de metas financeiras e custos estimados para a temporada.
*   **Dashboard Visual:** Gráficos e barras de progresso exibindo o montante arrecadado versus a meta final.
*   **Automação de Contrapartidas:** Geração automática de cronograma de tarefas de marketing assim que uma parceria é fechada.
